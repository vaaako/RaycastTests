...
g++ -c main.cpp src/*.cpp $DEBUG -lGL -lGLU -lglut -lm -lsfml-graphics -lsfml-window -lsfml-system # Build cpp files
g++ *.o $DEBUG -lGL -lGLU -lglut -lm -lsfml-graphics -lsfml-window -lsfml-system -o $NAME   # Compile to executable
